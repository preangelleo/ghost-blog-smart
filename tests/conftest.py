...
def mock_ghost_functions():
    ...
    with patch('ghost_blog_smart.create_ghost_blog_post') as mock_create, \
         patch('ghost_blog_smart.smart_blog_gateway') as mock_smart, \
         patch('ghost_blog_smart.get_ghost_posts') as mock_get_posts, \
         patch('ghost_blog_smart.update_ghost_post') as mock_update, \
         patch('ghost_blog_smart.delete_ghost_post') as mock_delete, \
         patch('ghost_blog_smart.update_ghost_post_image') as mock_update_image, \
         patch('ghost_blog_smart.get_ghost_posts_advanced') as mock_get_advanced, \
         patch('ghost_blog_smart.get_ghost_post_details') as mock_get_details, \
         patch('ghost_blog_smart.get_posts_summary') as mock_summary, \
         patch('ghost_blog_smart.batch_get_post_details') as mock_batch, \
         patch('ghost_blog_smart.find_posts_by_date_pattern') as mock_date_search:
