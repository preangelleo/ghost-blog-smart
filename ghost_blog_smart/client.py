...
class GhostBlogSmart:
    ...
    def __init__(self, 
        ...
        self.ghost_api_url = ghost_url or os.getenv('GHOST_API_URL') or os.getenv('GHOST_BLOG_URL')
        self.ghost_admin_api_key = ghost_api_key or os.getenv('GHOST_ADMIN_API_KEY') or os.getenv('GHOST_BLOG_ADMIN_API_KEY')
        self.gemini_api_key = gemini_api_key or os.getenv('GEMINI_API_KEY')
        
        # Validate required credentials
        if not self.ghost_api_url:
            raise ValueError("Ghost API URL is required. Set GHOST_API_URL environment variable or pass ghost_url parameter.")
        if not self.ghost_admin_api_key:
            raise ValueError("Ghost Admin API Key is required. Set GHOST_ADMIN_API_KEY environment variable or pass ghost_api_key parameter.")
    ...
    def get_posts_summary(self, date_from=None, date_to=None, **kwargs) -> Dict[str, Any]:
        """
    ...
    def __repr__(self) -> str:
        ...
        ai_status = "with AI features" if self.has_ai_features else "without AI features"
...
def create_client(ghost_url: Optional[str] = None,
                 ghost_api_key: Optional[str] = None,
                 gemini_api_key: Optional[str] = None) -> GhostBlogSmart:
    """
